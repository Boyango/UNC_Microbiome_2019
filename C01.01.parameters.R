...
### 0.2 Data
  ...
  gene.marginal.RPK.RNA <- readRDS("Data.gene.marginal.RPK.RNA.118.rds")
  outcome <- readRDS("Data.outcome118.rds")
  # gene.marginal.RPK.RNA %>% names

  # filtering 2 lowly-expressed subjects (352, 420)
  gene.marginal.RPK.RNA %>% select(-RPK.352, -RPK.420) -> DataRPK116
